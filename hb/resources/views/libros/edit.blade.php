    ...
    <div class="container">
        <div class="container-cr">
            <div class="cont-title">
                <h1 class="h1">Usted esta editando <p class="p">{{ $libro->name }}</p>
                </h1>
            </div>
            <div class="cont-form">
                <form action="{{ route('libros.update', $libro) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nombre
                            <br>
                            <input type="text" name="name" id="exampleFormControlInput1" value='{{old('name', $libro->name)}}'>
                        </label>
                        @error('name')
                            <br>
                            <small>{{ $message }}</small>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label" '>IMG
                             <br>
                            <input type="text" name="img" id="exampleFormControlInput1" value='
                            {{ old('img',$libro->img)}}' placeholder="">
                        </label>
                        @error('name')
                            <br>
                            <small>{{ $message }}</small>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Fecha de carga
                            <br>
                            <input type="date" name="publication_date" id="exampleFormControlInput1"
                                value='{{ old('publication_date',$libro->publication_date) }}' placeholder="">
                        </label>
                        @error('date')
                            <br>
                            <small>{{ $message }}</small>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">Descripcion
                            <textarea name="description" class="form-control" id="exampleFormControlTextarea1"
                                rows="10"> {{ old('description',$libro->description) }}'</textarea>
                        </label>
                        @error('description')
                            <br>
                            <small>{{ $message }}</small>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Autor
                            <br>
                            <input type="text" name="Author" id="exampleFormControlInput1" value='{{ old('Author',$libro->Author) }}'
                                placeholder="">
                        </label>
                        @error('Author')
                            <br>
                    ...
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Link
                            <br>
                            <input type="text" name="link" id="exampleFormControlInput1" value='{{ old('link',$libro->link) }}'
                                placeholder="">
                        </label>
                        @error('link')
                            <br>
