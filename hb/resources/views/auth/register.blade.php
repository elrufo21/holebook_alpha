...
@section('content')
    <form method="post" action="{{ route('register.perform') }}" class="container w-25">
        ...
        <div class="form-group form-floating mb-3">
            <input type="password" class="form-control" name="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Confirma tu contraseña" required="required">
            <label for="floatingConfirmPassword">Confirma tu contraseña</label>
